    ...
    return WillPopScope(
      ...
      child: BlocConsumer(
          ...
          listener: (context, state) {
            if (state is ConfigStateMessage) {
                  ...
                  body: Column(
                    ...
                    children: <Widget>[
                      ...
                      MenuItem(
                        ...
                        onTap: () => Modular.to
                            .pushNamed('/profile/personal', arguments: model),
                      ),
                      ...
                      _rootEventDateIsSet
                          ? MenuItem(
                              ...
                              onTap: () =>
                                  Modular.to.pushNamed('/profile/config'),
                            )
                          : AnimatedMenuItem(
                        ...
                        onTap: () async {
                          final confirm = await showDialog<bool>(
                                ...
                                builder: (context) => ConfirmDialog(
                                  title:
                                      localizations.recoveryWarningDialogTitle,
                                  subtitle: localizations
                                      .recoveryWarningDialogSubtitle,
                        ...
                        onPressed: () async {
                          final confirm = await showDialog<bool>(
                                ...
                                builder: (context) => ConfirmDialog(
                                  ...
                                  subtitle:
                                      localizations.resetWalletConfirmationText,
                                ),
                              ) ??
                              false;
                          ...
                          if (confirm) {
                            ...
                            final repository =
                                Modular.get<CredentialsRepository>();
